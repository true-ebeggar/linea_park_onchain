...
class LineaTxnManager:
    ...
    def bilinear_claim(self):
        data = ("")
        gas = random.randint(300000, 350000)

        try:
            txn = {
                'to': self.w3.to_checksum_address(bilinear_contract),
                'value': 0,
                'gas': gas,
                'data': data,
                'gasPrice': int(self.w3.to_wei(0.5, 'gwei')),
                'nonce': self.w3.eth.get_transaction_count(self.address),
            }
            return self._submit_and_log_transaction(txn)
        except Exception as e:
